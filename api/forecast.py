...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            if cached:
                return self._json(cached['content'])
            ...
            natal = calc_positions(bdate.year, bdate.month, bdate.day, btime.hour, btime.minute, lat, lon_c)
            t = date.today()
            transits = calc_positions(t.year, t.month, t.day, 12, 0, lat, lon_c)
